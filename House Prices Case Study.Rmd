...
# PRESS(fit2) #Press not working with caret models
...
# PRESS(fit3) # Press not working with caret models
...
# PRESS(fit4) # Press not working with caret models
varImp(fit4$finalModel)


# Output the predictions for the test set to a csv file
fit4x <- glm(formula = formula(fit4), data = train)
stepwise_pred <- predict(fit4x, newdata = test)
